...
const { data: messages, error, mutate} = useSWR('/api/fetchMessages', fetcher);
...
// console.log(messages);
  ...
  return (
    ...
    >
      ...
      focus:ring-2 focus:ring-blue-600 focus:border-transparent px-5 py-2 disabled:opacity-50 disabled:cursor-not allowed 
      "
      />
      <button
        type="submit"
